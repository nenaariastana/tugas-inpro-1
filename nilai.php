...
?>
  ...
  <tr>
	...
	<th><font color="white">Nilai Angka</font></th>
    <th><font color="white">Nilai Huruf</font></th>
  </tr>
  <?php foreach($test->Selectp() as $value){ ?>
  <tr>
    <td><font color="white"><?php echo $value['judul']; ?></font></td>
    <td><font color="white"><?php echo $value['NIK']; ?></font></td>
	<td><font color="white"><?php echo $value['Nilaiangka']; ?></font></td>
    <td><font color="white"><?php echo $value['nilaiHuruf']; ?></font></td>
  </tr>
  <?php } ?>
</table>
    </div>
    ...
    <li><a href="jadwal.php">Lihat Jadwal</a></li><br>
    <li><a class="current"href="nilai.php">Lihat Nilai</a></li><br>
